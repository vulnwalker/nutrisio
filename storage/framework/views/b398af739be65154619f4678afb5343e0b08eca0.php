        ...
        <div class="wpb_wrapper">
            ...
            <div class="row">
                <div class="section-title text-center col-lg-10 offset-lg-1">
                    ...
                    <p class="p-lg -color" style="background: whitesmoke;">Kode Unik anda : <br>  <?php echo e(substr( $kodeUnik ,-3)); ?> <br> <span style="color:red;">Mohon di iklaskan 3 Digit anda untuk mempermudah pengecekan kami</span></p>
...
<hr>
                    ...
                    <a href="http://api.whatsapp.com/send?phone=6282127777362&text=Konfirmasi%20order%20no%20<?php echo e($penjualan[0]->id); ?>" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Place order" data-value="Place order">Konfirmasi</a>
                    </p>
                </div>
            </div>
            <!-- END SECTION TITLE -->
