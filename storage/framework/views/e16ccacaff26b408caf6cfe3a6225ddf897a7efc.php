<?php /* /var/www/html/nutrisio.rm-rf.studio/resources/views/content/home.blade.php */ ?>
                                    ...
                                    <div class="hero-img portfolio-items-list">
                                        <div class="masonry-wrap grid-loaded">
                                            ...
                                            <div class="portfolio-item width_2">
                                                <img class="img-fluid" src="<?php echo e(asset('images/nutrisio_banner.png')); ?>" alt="Image 1" />
                                            </div>
                                            <!-- IMAGE #1 -->

                                            <div class="portfolio-item width_2">
                                                <img class="img-fluid" src="<?php echo e(asset('images/nutrisio_banner4.png')); ?>" alt="Image 2" />
                                            </div>
                                            <!-- IMAGE #1 -->

                                            <div class="portfolio-item width_2">
                                                <img class="img-fluid" src="<?php echo e(asset('images/nutrisio_banner2.png')); ?>" alt="Image 3" />
                                            </div>
                                            <!-- IMAGE #1 -->

                                            <div class="portfolio-item width_2">
                                                <img class="img-fluid" src="<?php echo e(asset('images/nutrisio_banner3.png')); ?>" alt="Image 4" />
                                            </div>
                                            <!-- IMAGE #1 -->
                                        </div>
                                    </div>
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-6 col-lg-5">
                                    ...
                                    <div class="about-img wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                                        ...
                                        <img class="img-fluid" src="<?php echo e(asset('asset-content/themes/genemy/images/image-01.png')); ?>" alt="Welcome to Genemy">
                                    </div>
                                </div>
