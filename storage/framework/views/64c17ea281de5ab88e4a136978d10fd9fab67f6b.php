<?php /* /var/www/html/nutrisio/resources/views/content/checkoutSuccess.blade.php */ ?>
        ...
        <div class="wpb_wrapper">
            ...
            <div class="row">
                <div class="section-title text-center col-lg-10 offset-lg-1">
                    ...
                    <p class="p-lg -color" style="background: whitesmoke;">Melakukan pembayaran sebesar <br> Rp <?php echo e($penjualan[0]->total); ?></p>
