                                                        ...
                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                            ...
                                                            <p class="form-row form-row-wide validate-required validate-email" id="billing_email_field" data-priority="110">
                                                                ...
                                                                @if(!empty(Auth::user()->id))
                                                                 <input type="email" class="input-text " name="email" id="email" value="{{Auth::user()->email}}" readonly>
                                                                @else
                                                            ...
                                                            <select class="js-example-basic-single"  id="provinsi" name="provinsi" onchange="getKota()">
                                                                <option value=""></option>
                                                                @foreach ($dataProvinsi as $getDataProv)
                                                                <option value="{{ $getDataProv['province_id'] }} ">{{ $getDataProv['province'] }} </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <table class="shop_table woocommerce-checkout-review-order-table">
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr class="order-total">
                                                            <th>Total</th>
                                                            <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol" id="totalHargaSpan">Rp {{ number_format($total[0]->totalHarga,0," ",".") }}</span></span></strong> </td>
                                                        </tr>
