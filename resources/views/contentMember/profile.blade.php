      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form id="Update-form" action="{{ route('profileUpdate') }}" method="POST">
              	 {{ csrf_field() }}
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="input-email" class="form-control" value="{{ Auth::user()->email }}" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        @else
                        	 <input type="text" name="nama_bank" class="form-control" value="{{ Auth::user()->nama_bank}}" readonly>
                        @endif
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        @if(Auth::user()->nomor_rekening == "")
                       		 <input type="text" name="nomor_rekening" class="form-control" value="">
                        @else
                        	 <input type="text" name="nomor_rekening" class="form-control" value="{{ Auth::user()->nomor_rekening}}" readonly>
                        @endif
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nomor_telepon" class="form-control" placeholder="First name" value="{{ Auth::user()->nomor_telepon}}">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
